MoneyView = {
  ...
  renderExpenditures: function(data) {
    ...
    var HeaderBoxP2 = "<h1 class='text-center'>Expenditure List</h1></div>";
    var expenditureInfo = "";
    var emptyTableMsg = "";
    var TableHeader = "";
    var expenditureList = "";
    ...
    expenditureInfo = HeaderBoxP1 + HeaderBoxP2 + "<table class='table'>" + TableHeader + expenditureList + "</table>";
